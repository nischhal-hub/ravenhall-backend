...
export const createLane = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const updateLane = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const deleteLane = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const blockSlots = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const unblockSlots = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const getRevenueReport = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    const report = await adminService.getRevenueReport(
      from as string, to as string, (groupBy as string) || "day"
    );
...
export const getAllUsers = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const pagination = getPaginationParams(req.query);
    const result = await adminService.getAllUsers(pagination, req.query.search as string);
    sendSuccess(res, result);
  } catch (error) { next(error); }
};
